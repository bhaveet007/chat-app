...
import NotificationTemplateRouter from './NotificationTemplate'

const { sendResponse } = routerUtils

const Routes = [
  { path: '/', router: HomeRouter },
  { path: '/dispatch', router: DispatchRouter },
  { path: '/notification-template', router: NotificationTemplateRouter }
]
